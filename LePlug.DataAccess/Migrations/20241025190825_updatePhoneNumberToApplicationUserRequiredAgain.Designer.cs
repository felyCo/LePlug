...
namespace LePlug.DataAccess.Migrations
{
    ...
    [Migration("20241025190825_updatePhoneNumberToApplicationUserRequiredAgain")]
    partial class updatePhoneNumberToApplicationUserRequiredAgain
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LePlug.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LePlug.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LePlug.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LePlug.Models.OrderDetail", b =>
                {
                    b.HasOne("LePlug.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LePlug.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("LePlug.Models.OrderHeader", b =>
                {
                    b.HasOne("LePlug.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("LePlug.Models.ApplicationUser", b =>
                {
                    b.HasOne("LePlug.Models.Company", "Company")
                        .WithMany()
